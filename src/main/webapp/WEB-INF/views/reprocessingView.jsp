    ...
    <div class="main">
        ...
        <div id="waiting">
            ...
            <div style="display: inline-block; padding-left: 20px; vertical-align: top">
                <h1>Die Version ${version} von ${institution} wird neu verarbeitet und nach ${core} indiziert...</h1>
        ...
        <div id="success" style="display: none;">
            <h1>Neuverarbeitung der Version ${version} von ${institution} und Indizierung nach ${core} erfolgreich!</h1>
            <p>Die Daten wurden erfolgreich eingespielt.</p>
        </div>

        <div id="failure" style="display: none;">
            <h1>Neuverarbeitung der Version ${version} von ${institution} und Indizierung nach ${core} fehlgeschlagen!</h1>
            <h2>Exception: </h2>
